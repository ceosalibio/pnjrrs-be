...
use App\Http\Controllers\ReportFacilityController;
...
Route::middleware('auth:sanctum')->prefix('v1')->group(function () {
    ...
    Route::prefix('report')->group(function () {
        ...
        Route::get('facilities/grouped-by-office', [ReportFacilityController::class, 'getItemsGroupedByOffice']);
        Route::apiResource('facilities', ReportFacilityController::class);
    });
    // route for settings
