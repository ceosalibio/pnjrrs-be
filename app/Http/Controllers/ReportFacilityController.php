...
use App\Services\ReportFacilityService;
use Illuminate\Http\Request;
use App\Traits\APIResponse;

class ReportFacilityController extends Controller
{
    use APIResponse;

    public function __construct(private ReportFacilityService $service)
    {
    }
    ...
    public function index(Request $request)
    {
        try {
            ...
            return $this->successResponse($reports, 'Facility Reports retrieved successfully');
        } catch (\Exception $e) {
    ...
    public function store(Request $request)
    {
        try {
            ...
            return $this->successResponse($result, 'Facility Report created successfully', 201);
    ...
    public function show($id)
    {
        try {
            ...
            if (!$report) {
                return $this->errorResponse('Facility Report not found', 404);
            }
            return $this->successResponse($report, 'Facility Report retrieved successfully');
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return $this->successResponse($report, 'Facility Report updated successfully');
        } catch (\Illuminate\Validation\ValidationException $e) {
            return $this->errorResponse($e->errors(), 422);
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
    ...
    public function destroy($id)
    {
        try {
            ...
            return $this->successResponse(null, 'Facility Report deleted successfully');
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
