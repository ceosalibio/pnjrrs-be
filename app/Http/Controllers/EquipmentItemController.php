...
class EquipmentItemController extends Controller
{
    ...
    public function __construct(private EquipmentItemService $service)
    {
    }
    ...
    public function index(Request $request)
    {
        try {
            ...
            if ($search) {
                ...
                return $this->successResponse($items, 'Equipment items search results retrieved successfully');
            }
            ...
            return $this->successResponse($items, 'Equipment items retrieved successfully');
        } catch (\Exception $e) {
    ...
    public function store(Request $request)
    {
        try {
            ...
            return $this->successResponse($item, 'Equipment item created successfully', 201);
    ...
    public function show($id)
    {
        try {
            ...
            if (!$item) {
                return $this->errorResponse('Equipment item not found', 404);
            }
            return $this->successResponse($item, 'Equipment item retrieved successfully');
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return $this->successResponse(null, 'Equipment item updated successfully');
        } catch (\Illuminate\Validation\ValidationException $e) {
            return $this->errorResponse($e->errors(), 422);
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
    ...
    public function destroy($id)
    {
        try {
            ...
            return $this->successResponse(null, 'Equipment item deleted successfully');
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
    ...
    public function getByUnit($unitId)
    {
        try {
            ...
            return $this->successResponse($items, "Equipment items for unit '{$unitId}' retrieved successfully");
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
    ...
    public function getByYear($year)
    {
        try {
            ...
            return $this->successResponse($items, "Equipment items for year '{$year}' retrieved successfully");
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
    ...
    {
        try {
            $items = $this->service->getTemplate();
            return $this->successResponse($items, "Equipment Template items retrieved successfully");
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
    ...
    /**
     * Get equipment template grouped by category, division, and type
     */
    public function getTemplateGrouped()
    {
        try {
            $grouped = $this->service->getTemplateGrouped();
            return $this->successResponse($grouped, "Equipment Template items grouped by category, division, and type retrieved successfully");
        } catch (\Exception $e) {
            return $this->errorResponse($e->getMessage(), 500);
        }
    }
